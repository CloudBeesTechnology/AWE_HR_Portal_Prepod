...
//   const [IVSSDetails, setIVSSDetails] = useState([]);
...
//          //Interview Schedule
//             client
//             .graphql({ query: listInterviewScheduleSchemas })
//             .catch(() => ({ data: { listInterviewScheduleSchemas: { items: [] } } })),
...
//       const IVSSItems =
//       IVSSResponse?.data?.listInterviewScheduleSchemas?.items || [];
//       setIVSSDetails(IVSSItems);
//       console.log("IVSSItems Details Data:", IVSSItems);
