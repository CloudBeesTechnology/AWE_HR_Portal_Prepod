...
//                       >
//                         <span className={`${
//                           idx === 0 ? "rounded-md text-primary" : "" // Highlight the last value
//                         }`}>{item} </span>
//                        <span > {idx < value.length - 1 && ","}{""} &nbsp;</span> 
//                         {/* Add a comma except for the last item */}
//                       </span>
//                       ))
//                   : value
...
//       <div className="flex flex-col md:flex-row items-start justify-between gap-8">
//         <div className="flex-1">
//           <div className="flex-1">{renderPersonalDetails(insuranceInfo)}</div>
//         </div>
//       </div>
//       <div className="mt-8">
//         <h6 className="uppercase text_size_5  my-3">Uploaded Documents:</h6>
//         {renderDocumentsUnderCategory(empInsUpload, "Induction Briefing")}
//       </div>
