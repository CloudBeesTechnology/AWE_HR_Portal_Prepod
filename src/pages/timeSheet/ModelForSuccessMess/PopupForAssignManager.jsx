        ...
        <main className="mt-4">
          <form className="grid grid-cols-1 gap-4">
            <div>
              ...
              />
              {errors.mbadgeNo && <p className="text-red text-xs">{errors.mbadgeNo}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-dark_grey outline-none rounded text-sm py-1.5 px-3"
              />
              {errors.mName && <p className="text-red text-xs">{errors.mName}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-dark_grey outline-none rounded text-sm py-1.5 px-3"
              />
              {errors.mdepartment && <p className="text-red text-xs">{errors.mdepartment}</p>}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full border border-dark_grey outline-none rounded text-sm py-1.5 px-3"
                />
                {errors.mfromDate && <p className="text-red text-xs">{errors.mfromDate}</p>}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-600">
                  Until
                ...
                <input
                  ...
                  className="mt-1 block w-full border border-dark_grey outline-none rounded text-sm py-1.5 px-3"
                />
                {errors.muntilDate && <p className="text-red text-xs">{errors.muntilDate}</p>}
              </div>
            </div>
          </form>
        </main>
