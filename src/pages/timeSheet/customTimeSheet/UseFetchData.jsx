      ...
      try {
        ...
        do {
          ...
          const processedData = fetchedData.map((item) => {
            ...
            const managerDetails=item.managerDetails;
            const managerData=JSON.parse(managerDetails);
            ...
            if (Array.isArray(rawSheet) && rawSheet.length > 0) {
              ...
              try {
                ...
                return [{ id: id }, dataWithStatus,managerData];
              } catch (error) {
          ...
          const validData = processedData.filter((item) => item !== null || item !== undefined);
