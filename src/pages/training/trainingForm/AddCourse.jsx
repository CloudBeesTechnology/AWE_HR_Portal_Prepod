...
export const AddCourse = () => {
  ...
  // Fetch and merge employee and course details
  useEffect(() => {
    const fetchData = () => {
      try {
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-4">
                ...
                {errors.courseSelect && (
                  <p className="text-red-500">{errors.courseSelect.message}</p>
                )}
              </div>
  ...
  // </div>
      ...
      {/* Outlet for further navigation
      <div>
        <Outlet context={{ searchResultData }} />
      </div> */}
    </section>
  );
};
...
//     handleSubmit,
//     formState: { errors },
//     setValue, // Use setValue to update the form based on the selected course
//   } = useForm({
//     resolver: yupResolver(CourceValidationSchema),
//   });
