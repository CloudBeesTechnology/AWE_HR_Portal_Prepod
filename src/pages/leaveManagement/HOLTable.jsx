...
export const HOLTable = ({ initialData, userType, formatDate, personalInfo }) => {
  ...
  const filteredData = initialData?.filter(item => {
    ...
    const isAllowedUser =
      personalInfo.name === supervisorName || personalInfo.name === managerName  || userType === "SuperAdmin" || userType === "HR";
            ...
            filteredData.map((item, index) => {
              return (
                ...
                >
                  ...
                  <td className="border-b-2 border-[#CECECE]">{formatDate(item.fromDate)}</td>
                  <td className="border-b-2 border-[#CECECE]">{formatDate(item.toDate)}</td>
                  <td className="border-b-2 border-[#CECECE]">{item.reason}</td>
                  <td
                    className={`${getStatusClass(
                      userType === "Manager"
