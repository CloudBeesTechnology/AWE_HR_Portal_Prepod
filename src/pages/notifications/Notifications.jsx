...
// Custom skeleton loader for notification rows
const NotificationRowSkeleton = () => (
  <tr className="border-b last:border-b-0 animate-pulse">
    <td className="p-7 w-[150px]">
      <div className="h-4 bg-ash rounded w-3/4"></div>
    </td>
    <td className="p-7 text_size_6 text-dark_grey flex flex-col gap-y-3">
      <div className="h-4 bg-ash rounded w-1/2 mb-2"></div>
      <div className="h-3 bg-ash rounded w-full"></div>
    </td>
    <td className="text-center p-7">
      <div className="h-4 bg-ash rounded w-16 mx-auto"></div>
    </td>
    <td className="px-4 text-center">
      <div className="h-6 bg-ash rounded w-16 mx-auto"></div>
    </td>
  </tr>
);
  ...
  return (
    <section className="p-10 bg-[#F7F8F4] shadow-md rounded-lg min-h-screen">
      <div className="bg-white rounded-2xl">
        ...
        {!matchingNotifications || matchingNotifications?.length === 0 ? (
          <table className="w-full text-sm">
            <thead className="text-grey">
              <tr className="uppercase bg-[#F1F1F1]">
                <th className="p-7 text-left">Date</th>
