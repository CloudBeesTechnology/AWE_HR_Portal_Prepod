...
export const CandiToEmp = async ({ storedData }) => {
  ...
  const PassportValid = {
    ...
    // reEntryUpload: storedData.WPTrackDetails_airticketfile,
  ...
  try {
    ...
    // console.log(
    //   "storedData.interviewDetails_id, : ",
    //   storedData.interviewDetails_id
    // );
    // console.log("storedData.empID : ", storedData.empID);
    ...
    //     console.log(err);
    //   });
    // console.log(updatingStatus,"111111111111");
    return {
      success: true,
  ...
  //   [client]
  // );
  // const result = await SumbitCandiToEmp({ storedData });
