...
import icon4 from "../../assets/recruitment/recruitdash/non-local-cv.svg";
...
export const RecDashdetails = [
  {
    ...
    bg1: "bg-[#C9C9C9]",
    icons: icon7,
    title: "Apply Employee Requisition", // Ensure this matches exactly
    path: "applyemployreq",
  },
  {
    bg: " shadow-[0_1px_4px_1px_rgba(0,0,0,0.2)]",
    bg1: "bg-[#9BE9FF]",
    icons: icon1,
