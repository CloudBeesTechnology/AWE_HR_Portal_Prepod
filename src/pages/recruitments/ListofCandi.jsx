...
export const ListofCandi = () => {
  ...
  useEffect(() => {
    ...
    // Sort the candidates by tempID
    const sortedCandidates = allCandidates.sort((a, b) => {
      const tempIDA = a.tempID.replace("TEMP", "");
      const tempIDB = b.tempID.replace("TEMP", "");
      return parseInt(tempIDA, 10) - parseInt(tempIDB, 10);
    });

    setFilteredData(sortedCandidates);
    setLoading(false);
