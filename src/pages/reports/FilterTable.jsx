...
//   // Filter tableBody based on searchQuery
...
// //       <tr key={rowIndex} className="text-sm border-b-2 border-[#CECECE]">
// //         {Object.entries(row).map(([key, col], colIndex) => {
// //           // Check if the column is the expiry status and determine if it's expired
// //           const isExpired = key === "expAndValid" && col === "EXPIRED";
...
// //  {/* <tbody className="bg-white">
// //                 {tableBody.map((row, rowIndex) => {
// //                   // Ensure that `row` is an object with key-value pairs
// //                   return (
// //                     <tr key={rowIndex} className="text-sm border-b-2 border-[#CECECE]">
// //                       {Object.values(row).map((col, colIndex) => {
// //                         // Log column data if needed
// //                         return (
