...
export const DeleteDocsTriningEmpR = (fileType, fileName, empID,setUploadedFileNames,setUploadMedicalReports,setIsUploading) => {
try{
    ...
    console.log(error,"DeleteDocsTriningEmpR in employe info");
