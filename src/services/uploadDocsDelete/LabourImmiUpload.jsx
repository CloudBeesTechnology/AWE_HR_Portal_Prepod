...
export const LabourImmiUpload = (fileType, fileName, empID,setUploadedFileNames,setDocsUploaded,setIsUploading) => {
try{
    ...
    console.log(error,"LabourImmiUpload in employe info");
