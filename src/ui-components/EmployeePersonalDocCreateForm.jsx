...
export default function EmployeePersonalDocCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setEmployeeBadgeNumber(initialValues.employeeBadgeNumber);
    setSapNumber(initialValues.sapNumber);
    setNationalCategory(initialValues.nationalCategory);
    setCountryOfOrigin(initialValues.countryOfOrigin);
    setOtherCountryOfOrigin(initialValues.otherCountryOfOrigin);
    setEducationLevel(initialValues.educationLevel);
    setAcademicTechnicalQualification(
      initialValues.academicTechnicalQualification
    );
    setNextOfKin(initialValues.nextOfKin);
    setCurrentNextOfKinValue("");
    setInductionBriefing(initialValues.inductionBriefing);
    setPreviousEmployment(initialValues.previousEmployment);
    setPreviousEmploymentPeriod(initialValues.previousEmploymentPeriod);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new EmployeePersonalDoc(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "EmployeePersonalDocCreateForm")}
      {...rest}
    >
      <TextField
        label="Passport no"
