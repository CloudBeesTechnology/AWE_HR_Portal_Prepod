...
export declare type LabourDetailsCreateFormInputValues = {
    empID?: string;
...
export declare type LabourDetailsCreateFormValidationValues = {
...
export declare type LabourDetailsCreateFormOverridesProps = {
    LabourDetailsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type LabourDetailsCreateFormProps = React.PropsWithChildren<{
    overrides?: LabourDetailsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: LabourDetailsCreateFormInputValues) => LabourDetailsCreateFormInputValues;
    onSuccess?: (fields: LabourDetailsCreateFormInputValues) => void;
    onError?: (fields: LabourDetailsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: LabourDetailsCreateFormInputValues) => LabourDetailsCreateFormInputValues;
    onValidate?: LabourDetailsCreateFormValidationValues;
} & React.CSSProperties>;
export default function LabourDetailsCreateForm(props: LabourDetailsCreateFormProps): React.ReactElement;
