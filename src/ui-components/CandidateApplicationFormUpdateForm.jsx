...
import { getCandidateApplicationForm } from "../graphql/queries";
import { updateCandidateApplicationForm } from "../graphql/mutations";
...
export default function CandidateApplicationFormUpdateForm(props) {
  const {
    id: idProp,
    candidateApplicationForm: candidateApplicationFormModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = candidateApplicationFormRecord
      ? { ...initialValues, ...candidateApplicationFormRecord }
      : initialValues;
    ...
    setEmployeeType(cleanValues.employeeType);
    setName(cleanValues.name);
    setChinese(cleanValues.chinese);
    setGender(cleanValues.gender);
    setAge(cleanValues.age);
    setEmail(cleanValues.email);
    setCountryOfBirth(cleanValues.countryOfBirth);
    ...
    setIcNo(cleanValues.icNo);
    setIcExpiry(cleanValues.icExpiry);
    setIcColour(cleanValues.icColour);
    ...
    setDiseaseDescription(cleanValues.diseaseDescription);
    setLiquorDescription(cleanValues.liquorDescription);
    setCrimeDescription(cleanValues.crimeDescription);
    setSalaryException(cleanValues.salaryException);
    setNoticePeriod(cleanValues.noticePeriod);
    setEmployeeStatement(cleanValues.employeeStatement);
    setPerInterviewStatus(cleanValues.perInterviewStatus);
    setPerInterviewDescription(cleanValues.perInterviewDescription);
    ...
    setUploadPassport(cleanValues.uploadPassport);
    setDateOfBirth(cleanValues.dateOfBirth);
    setTempID(cleanValues.tempID);
    setExperience(cleanValues.experience);
    setErrors({});
  };
  const [candidateApplicationFormRecord, setCandidateApplicationFormRecord] =
    React.useState(candidateApplicationFormModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getCandidateApplicationForm.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getCandidateApplicationForm
        : candidateApplicationFormModelProp;
      setCandidateApplicationFormRecord(record);
    };
    queryData();
  }, [idProp, candidateApplicationFormModelProp]);
  React.useEffect(resetStateValues, [candidateApplicationFormRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          countryOfBirth,
          nationality,
          otherNationality: otherNationality ?? null,
          marital,
          race,
          ...
          liquorDescription: liquorDescription ?? null,
          crimeDescription: crimeDescription ?? null,
          salaryException: salaryException ?? null,
          noticePeriod,
          employeeStatement,
          perInterviewStatus,
          perInterviewDescription: perInterviewDescription ?? null,
        ...
        try {
          ...
          await client.graphql({
            query: updateCandidateApplicationForm.replaceAll("__typename", ""),
            variables: {
              input: {
                id: candidateApplicationFormRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "CandidateApplicationFormUpdateForm")}
      {...rest}
    >
      <TextField
        label="Profile photo"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || candidateApplicationFormModelProp)}
