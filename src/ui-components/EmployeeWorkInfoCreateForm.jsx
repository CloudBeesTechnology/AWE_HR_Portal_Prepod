...
export default function EmployeeWorkInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new EmployeeWorkInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "EmployeeWorkInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
