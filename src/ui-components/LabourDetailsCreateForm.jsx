...
import { createLabourDetails } from "../graphql/mutations";
const client = generateClient();
export default function LabourDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setWorkPermitType(initialValues.workPermitType);
    setArrivalStampingExpiry(initialValues.arrivalStampingExpiry);
    setEmploymentPassEndorsemen(initialValues.employmentPassEndorsemen);
    setImmigrationDeptDate(initialValues.immigrationDeptDate);
    setEmploymentPassExpiry(initialValues.employmentPassExpiry);
    setEmploymentPassStatus(initialValues.employmentPassStatus);
    setOverseasMedicalDate(initialValues.overseasMedicalDate);
    setOverseasMedicalExpiry(initialValues.overseasMedicalExpiry);
    setBruhimsRegistrationDate(initialValues.bruhimsRegistrationDate);
    setBruhimsRegistrationNumber(initialValues.bruhimsRegistrationNumber);
    setBruneiMedicalAppointmentDate(initialValues.bruneiMedicalAppointmentDate);
    setBruneiMedicalExpiry(initialValues.bruneiMedicalExpiry);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLabourDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LabourDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
