...
export declare type WorkInfoSchemaUpdateFormInputValues = {
    empID?: string;
    dateOfJoin?: string;
    department?: string;
    workPosition?: string;
...
export declare type WorkInfoSchemaUpdateFormValidationValues = {
...
export declare type WorkInfoSchemaUpdateFormOverridesProps = {
    WorkInfoSchemaUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type WorkInfoSchemaUpdateFormProps = React.PropsWithChildren<{
    overrides?: WorkInfoSchemaUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    workInfoSchema?: any;
    onSubmit?: (fields: WorkInfoSchemaUpdateFormInputValues) => WorkInfoSchemaUpdateFormInputValues;
    onSuccess?: (fields: WorkInfoSchemaUpdateFormInputValues) => void;
    onError?: (fields: WorkInfoSchemaUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: WorkInfoSchemaUpdateFormInputValues) => WorkInfoSchemaUpdateFormInputValues;
    onValidate?: WorkInfoSchemaUpdateFormValidationValues;
} & React.CSSProperties>;
export default function WorkInfoSchemaUpdateForm(props: WorkInfoSchemaUpdateFormProps): React.ReactElement;
