...
import { createSelectedCandidateSchema } from "../graphql/mutations";
const client = generateClient();
export default function SelectedCandidateSchemaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSelectedCandidateSchema.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SelectedCandidateSchemaCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
