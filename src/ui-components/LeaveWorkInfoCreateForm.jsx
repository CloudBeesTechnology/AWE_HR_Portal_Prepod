...
export default function LeaveWorkInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAnnualEntitlementeffectiveDate(
      initialValues.annualEntitlementeffectiveDate
    );
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LeaveWorkInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LeaveWorkInfoCreateForm")}
      {...rest}
    >
      <TextField
