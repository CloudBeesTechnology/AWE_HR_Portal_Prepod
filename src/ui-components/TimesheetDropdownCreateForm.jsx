...
import { createTimesheetDropdown } from "../graphql/mutations";
const client = generateClient();
export default function TimesheetDropdownCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setDropdownType(initialValues.dropdownType);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTimesheetDropdown.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TimesheetDropdownCreateForm")}
      {...rest}
    >
      <TextField
        label="Dropdown type"
