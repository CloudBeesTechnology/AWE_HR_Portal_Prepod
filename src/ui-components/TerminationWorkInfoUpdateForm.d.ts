...
export declare type TerminationWorkInfoUpdateFormInputValues = {
...
export declare type TerminationWorkInfoUpdateFormValidationValues = {
...
export declare type TerminationWorkInfoUpdateFormOverridesProps = {
    TerminationWorkInfoUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type TerminationWorkInfoUpdateFormProps = React.PropsWithChildren<{
    overrides?: TerminationWorkInfoUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    terminationWorkInfo?: TerminationWorkInfo;
    onSubmit?: (fields: TerminationWorkInfoUpdateFormInputValues) => TerminationWorkInfoUpdateFormInputValues;
    onSuccess?: (fields: TerminationWorkInfoUpdateFormInputValues) => void;
    onError?: (fields: TerminationWorkInfoUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: TerminationWorkInfoUpdateFormInputValues) => TerminationWorkInfoUpdateFormInputValues;
    onValidate?: TerminationWorkInfoUpdateFormValidationValues;
} & React.CSSProperties>;
export default function TerminationWorkInfoUpdateForm(props: TerminationWorkInfoUpdateFormProps): React.ReactElement;
