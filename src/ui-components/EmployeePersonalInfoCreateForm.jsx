...
export default function EmployeePersonalInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBruneiIcNo(initialValues.bruneiIcNo);
    setBruneiIcColour(initialValues.bruneiIcColour);
    setBruneiIcExpiry(initialValues.bruneiIcExpiry);
    setMalaysianIcNumber(initialValues.malaysianIcNumber);
    setMalaysianIcExpiry(initialValues.malaysianIcExpiry);
    setErrors({});
  };
  const validations = {
    empID: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new EmployeePersonalInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "EmployeePersonalInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
