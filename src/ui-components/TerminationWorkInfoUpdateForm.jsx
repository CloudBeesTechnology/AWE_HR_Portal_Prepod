...
export default function TerminationWorkInfoUpdateForm(props) {
  const {
    id: idProp,
    terminationWorkInfo: terminationWorkInfoModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = terminationWorkInfoRecord
      ? { ...initialValues, ...terminationWorkInfoRecord }
      : initialValues;
  ...
  const [terminationWorkInfoRecord, setTerminationWorkInfoRecord] =
    React.useState(terminationWorkInfoModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(TerminationWorkInfo, idProp)
        : terminationWorkInfoModelProp;
      setTerminationWorkInfoRecord(record);
    };
    queryData();
  }, [idProp, terminationWorkInfoModelProp]);
  React.useEffect(resetStateValues, [terminationWorkInfoRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            TerminationWorkInfo.copyOf(terminationWorkInfoRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "TerminationWorkInfoUpdateForm")}
      {...rest}
    >
      <TextField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || terminationWorkInfoModelProp)}
