...
export default function ApplicantDetailsUpdateForm(props) {
  const {
    id: idProp,
    applicantDetails: applicantDetailsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = applicantDetailsRecord
      ? { ...initialValues, ...applicantDetailsRecord }
      : initialValues;
  ...
  const [applicantDetailsRecord, setApplicantDetailsRecord] = React.useState(
    applicantDetailsModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ApplicantDetails, idProp)
        : applicantDetailsModelProp;
      setApplicantDetailsRecord(record);
    };
    queryData();
  }, [idProp, applicantDetailsModelProp]);
  React.useEffect(resetStateValues, [applicantDetailsRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ApplicantDetails.copyOf(applicantDetailsRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ApplicantDetailsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Profile photo"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || applicantDetailsModelProp)}
