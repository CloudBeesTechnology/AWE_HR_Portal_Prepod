...
export declare type CandidateApplicationFormCreateFormInputValues = {
    profilePhoto?: string;
    agent?: string;
    position?: string;
    contractType?: string;
...
export declare type CandidateApplicationFormCreateFormValidationValues = {
...
export declare type CandidateApplicationFormCreateFormOverridesProps = {
    CandidateApplicationFormCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CandidateApplicationFormCreateFormProps = React.PropsWithChildren<{
    overrides?: CandidateApplicationFormCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CandidateApplicationFormCreateFormInputValues) => CandidateApplicationFormCreateFormInputValues;
    onSuccess?: (fields: CandidateApplicationFormCreateFormInputValues) => void;
    onError?: (fields: CandidateApplicationFormCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CandidateApplicationFormCreateFormInputValues) => CandidateApplicationFormCreateFormInputValues;
    onValidate?: CandidateApplicationFormCreateFormValidationValues;
} & React.CSSProperties>;
export default function CandidateApplicationFormCreateForm(props: CandidateApplicationFormCreateFormProps): React.ReactElement;
