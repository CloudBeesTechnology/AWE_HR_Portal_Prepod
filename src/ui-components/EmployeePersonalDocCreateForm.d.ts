...
export declare type EmployeePersonalDocCreateFormInputValues = {
    passportNo?: string;
...
export declare type EmployeePersonalDocCreateFormValidationValues = {
...
export declare type EmployeePersonalDocCreateFormOverridesProps = {
    EmployeePersonalDocCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type EmployeePersonalDocCreateFormProps = React.PropsWithChildren<{
    overrides?: EmployeePersonalDocCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: EmployeePersonalDocCreateFormInputValues) => EmployeePersonalDocCreateFormInputValues;
    onSuccess?: (fields: EmployeePersonalDocCreateFormInputValues) => void;
    onError?: (fields: EmployeePersonalDocCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EmployeePersonalDocCreateFormInputValues) => EmployeePersonalDocCreateFormInputValues;
    onValidate?: EmployeePersonalDocCreateFormValidationValues;
} & React.CSSProperties>;
export default function EmployeePersonalDocCreateForm(props: EmployeePersonalDocCreateFormProps): React.ReactElement;
